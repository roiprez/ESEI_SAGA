...
public class Tablero extends Environment {
  ...
  public static final int EMPTY  = 2048;
  ...
  int [][] cellOwner = new int[GSize][GSize];
  ...
  public boolean executeAction(String agent, Structure message) {
    ...
    try {
      if (agent.equals("judge")) { //Recepcion de un mensaje procedente del juez
        ...
        switch(action){
          ...
          break;
          case("setOwner"): //Establecer propiedad de una celda
          x = (int)((NumberTerm)message.getTerm(0)).solve();
          y = (int)((NumberTerm)message.getTerm(1)).solve();
          int owner = (int)((NumberTerm)message.getTerm(2)).solve();
          model.setOwner(x,y,owner);
          break;
        }
    ...
    class TableroView extends GridWorldView {
      ...
      public void drawObstacle(Graphics g, int x, int y){
        ...
        //g.setColor(Color.black); //Descomentar si se desea relleno de los obstaculos para una mejor visualizacion
        //drawString(g,x,y,new Font("Arial", Font.BOLD, 50),"*");
      }
