...
+!realizarJugada : pensarJugada(P1,P2,Dir) <- 
					...
					.send(judge,tell,moverDesdeEnDireccion(pos(P1,P2),Dir)); // --- TODO --- Decisi�n de la jugada.
					.send(judge,untell,moverDesdeEnDireccion(pos(P1,P2),Dir)). 
					
//Movimiento realizado correctamente							
+valido[source(judge)] <-  .print("He realizado una Jugada V�lida!").
